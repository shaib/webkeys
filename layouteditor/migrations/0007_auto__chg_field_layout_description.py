...
class Migration(SchemaMigration):
    ...
    "Make Layout.description field not-null in the database"

    def forwards(self, orm):

        # Changing field 'Layout.description'
        db.alter_column('layouteditor_layout', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Layout.description'
        db.alter_column('layouteditor_layout', 'description', self.gf('django.db.models.fields.TextField')(null=True))
