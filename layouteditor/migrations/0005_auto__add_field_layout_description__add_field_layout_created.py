...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Layout.description'
        db.add_column('layouteditor_layout', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Layout.created'
        db.add_column('layouteditor_layout', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2012, 1, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Layout.description'
        db.delete_column('layouteditor_layout', 'description')

        # Deleting field 'Layout.created'
        db.delete_column('layouteditor_layout', 'created')
